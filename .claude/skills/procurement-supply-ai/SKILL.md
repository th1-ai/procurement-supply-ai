---
name: procurement-supply-ai
description: Run Procurement / Supply AI ("The Quartermaster") — Argues every order from the forecast, not habit.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Quartermaster", "/procurement-supply-ai", "check the queue", "what is waiting for me", "approve that draft".
---

# Procurement / Supply AI

Runs Procurement / Supply AI and works its review queue. Everything happens from the repo
